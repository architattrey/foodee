...
<script>
    ...
    promocodeApp.controller("promocodeController",function($scope, $http) {
        // promocode listing   
        //$scope.dtOptions = DTOptionsBuilder.newOptions().withOption('order', [0, 'asc']);
		
        $scope.promocodeData = [];
        $scope.getRequest = function() {
            $http.post("{{url('/')}}/get-promo-codes").then(response =>{
				$scope.promocodeData = [];
        ...
        $scope.addpromocode = function() {
            ...
            $http.post("{{url('/')}}/add-update-promocode",reqData).then(response =>{
                $scope.getRequest();
        ...
        $scope.deletePromocode = function() {
            ...
            $http.post("{{url('/')}}/delete-promocode",reqData).then(response =>{
                $scope.getRequest();
        ...
        $scope.uploadFile = function (files) {
            //debugger;
            var file = files;  
            var uploadUrl = "{{url('/')}}/promocode-image-upload";
