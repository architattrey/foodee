                    ...
                    <div class="modal-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="menu4" class="tab-pane fade">
                                ...
                                <div class="db-2-com db-2-main" id="content2" style="background-color:white;margin-left: 27px">
...
<script>
    var deliveriesApp = angular.module("deliveriesApp",[]);
    deliveriesApp.controller("deliveriesController",function($scope, $http) {
        // deliveries listing   
        ...
        $scope.getRequest = function() {
            $http.post("{{url('/')}}/get-deliveries").then(response =>{
        ...
        $scope.changeStatus =function(data){
            ...
            $http.post("{{url('/')}}/change-delivery-status",reqData).then(response =>{
        ...
        $scope.invoice = function(data){
            ...
            $http.post("{{url('/')}}/get-invoice-data",reqData).then(response =>{
