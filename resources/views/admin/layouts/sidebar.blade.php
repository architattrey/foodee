      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul>
            ...
            <li><a href="{{route('plan-actions')}}"><i class="fa fa-circle-o"></i>&nbsp;Add Plan </a></li>  
            <li><a href="{{route('promocode')}}"><i class="fa fa-circle-o"></i>&nbsp;Promo Code</a></li>
            <li><a href="{{route('days')}}"><i class="fa fa-circle-o"></i>&nbsp;Maintain Days</a></li>
            <li><a href="{{route('app-users')}}"><i class="fa fa-circle-o"></i>&nbsp;App Users</a></li>
