		...
		<div class="modal fade" id="transections" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content" id="transections_content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">All transactions of this user</h4>
                    </div>
                            ...
                            <div class="tractions">
                                ...
                                <section class="content" >
                                    <table id="categories"  datatable="ng" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody ng-repeat ="transaction in userTransactions">
                                            <tr>
                                                <td>@{{$index+1}}</td>
...
<script>
    ...
    usersApp.controller("userController",function($scope, $http) {
        ...
        $scope.getRequest = function() {
            $http.post("{{url('/')}}/get-user-data").then(response =>{
        ...
        $scope.deliveryAddress = function(data){
            ...
            $http.post("{{url('/')}}/get-user-delivery-address",reqData).then(response =>{
        ...
        $scope.userTransaction = function(data){
            ...
            $http.post("{{url('/')}}/user-transactions",reqData).then(response =>{
        ...
        $scope.userFeedbacks = function(data){
            ...
            $http.post("{{url('/')}}/user-feedbacks",reqData).then(response =>{
